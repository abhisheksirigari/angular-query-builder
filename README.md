...
A modernized Angular 6+ query builder based on jQuery QueryBuilder. Support for heavy customization with Angular components and provides a flexible way to handle custom data types.
...
# Workflow
See the [angular-library-seed](https://github.com/abhisheksirigari/angular-library-seed) project for details on how to build and run tests.
